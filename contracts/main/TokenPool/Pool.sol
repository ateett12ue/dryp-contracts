...
contract LiquidityPool is IERC721Receiver {
        ...
        )
    {
        ...
        TransferHelper.safeApprove(DRYP, address(nonfungiblePositionManager), amount1ToMint);
        ...
        if (amount1 < amount1ToMint) {
            TransferHelper.safeApprove(DRYP, address(nonfungiblePositionManager), 0);
